	...
	<div class="container-fluid">
		...
		<div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="https://www.webmandesign.eu">Premium WordPress themes</a></li>
				<li><a href="https://profiles.wordpress.org/webmandesign#content-themes">Free WordPress themes</a></li>
				<li><a href="https://www.webmandesign.eu/reference/#links-support">Support Forums</a></li>
			</ul>
		</div>
...
<section class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	...
	<header class="main-header"><div class="container-fluid">
			...
			<p class="lead">
				<strong>Thank you for using the Auberge restaurant & café & recipe blog WordPress theme by <a href="https://www.webmandesign.eu" target="_blank">WebMan Design</a>!</strong>
			</p>

			<p>This user manual will teach you how to set up and use the <strong>Auberge</strong> WordPress theme. In case you have any questions<br />that are beyond the scope of the user manual, please join <a href="https://www.webmandesign.eu/reference/#links-support" target="_blank"><strong>WebMan Design Support Forums</strong></a>. Enjoy your <strong>Auberge</strong> theme!</p>

			<hr>

			<p>
				Please note that this user manual covers both the free and <a href="https://www.webmandesign.eu/portfolio/auberge-plus-wordpress-theme/" target="_blank">premium theme version</a>.<br>The features marked with <a href="https://www.webmandesign.eu/portfolio/auberge-plus-wordpress-theme/" target="_blank" class="badge badge-plus">PLUS</a> are available <strong>in <a href="https://www.webmandesign.eu/portfolio/auberge-plus-wordpress-theme/" target="_blank">premium theme version</a> only</strong>.
			</p>
	...
	<div class="main-content"><div class="container-fluid">
			...
			<div class="section indented row">
				...
				<div class="col-sm-12 col-md-4">
					...
					<ul>
						...
						<li><a title="WordPress Glossary Terms for Beginners" href="http://www.wpbeginner.com/glossary/" target="_blank">WordPress Glossary Terms for Beginners</a></li>
						...
						<ul>
							...
							<li><a href="https://webdesign.tutsplus.com/courses/a-beginners-guide-to-using-wordpress" target="_blank">A Beginner's Guide to Using WordPress</a></li>
		...
		<h2 id="installation">Theme Installation</h2>
			<div class="section indented">
				...
				<div class="alert alert-success">
					<h4>Tip: Welcome page</h4>
					<p>After activating the theme, you can read the theme's welcome page navigating to <strong>Appearance &raquo; Welcome</strong> (you can disable this page in <strong><em>Appearance &raquo; Customize &raquo; Theme Options &raquo; Others</em></strong>).</p>
				</div>

				<div class="alert alert-info">
					<h4>Important: Subscribe for updates</h4>
					...
					<h4 class="mt"><strong>Automatic Theme Update</strong></h4>
						...
						<ul>
							...
							<li>
								...
								<p>You can obtain automatic theme updates with help of <a href="http://envato.github.io/wp-envato-market/" target="_blank"><strong>Envato Market</strong></a> plugin.<br>You can <a href="https://www.youtube.com/watch?v=aPm3D78rJDY" target="_blank">watch an instructional <strong>video</strong> on how to use the plugin</a>, read about the plugin at <a href="https://forums.envato.com/t/envato-market-wordpress-plugin-beta/21639" target="_blank">Envato forum article</a> or read a <a href="http://www.wpexplorer.com/envato-market-plugin-guide/" target="_blank">complete, illustrated instructions on how to use it</a>.</p>
							</li>
						</ul>
		...
		-->
		<h2 id="plugins">Installing Plugins <br><small><a href="#plugins-recommended">Main recommended plugins</a> | <a href="#plugins-others">Other useful plugins</a></small></h2>
			<div class="section indented">
				...
				<div class="row">
					...
					<div class="col-sm-12 col-md-4">
						...
						<p>The theme uses the <a href="http://tgmpluginactivation.com/" target="_blank">TGM Plugin Activation</a> script that prompts you to install recommended plugins after you activate the theme.</p>
						<p>The suggested recommended plugins are essential to provide the core functionality the theme relies on and/or to ease out the process of editing your website pages. <strong>You can still use the theme without these plugins, however, its functionality and your user experience would be limited.</strong></p>
					...
					<div class="col-sm-12 col-md-4">
						...
						<p>In case of any plugin incompatibility or error, please, <strong>contact the plugin support first</strong> before contacting <a href="https://www.webmandesign.eu/reference/#links-support">WebMan Design Support Center</a>.</p>

					</div>

				</div>

				<h3 id="plugins-recommended">Required and Recommended Plugins <br><small><a href="#plugins-others">Check out the list of other useful plugins too!</a></small></h3>
					...
					<div class="section indented plugins">
						...
						<h4 id="webman-amplifier">
							<strong>WebMan Amplifier</strong> <a href="https://www.webmandesign.eu/portfolio/auberge-plus-wordpress-theme/" target="_blank" class="badge badge-plus">PLUS</a><br />
				...
				<h3 id="plugins-others">Other Great Plugins Worth Checking Out</h3>

					<p>You can use any plugin with this theme. Here are some tested, used and recommended plugins by the <a href="https://www.webmandesign.eu">theme author</a>:</p>
		...
		<h2 id="demo-content">Installing Demo Content</h2>
			...
			<div class="section indented mt">
				...
				<div class="alert alert-info">
					<h3>Demo Images and Other Media Quality</h3>
					<p>Please understand that <strong>demo images, audio and video files are low quality</strong> due to copyright protection and you should replace them with your own, <a href="#credits">properly licensed images</a>.</p>
				</div>

				<div class="alert alert-warning">
					<h3>Demo Content Import Issues</h3>
			...
			<div class="section indented row">
				...
				<div class="col-sm-12 col-md-6">
					...
					<h3 class="mt-s">One-click Installation</h3>
				...
				<div class="col-sm-12 col-md-6">
					...
					<h3 class="mt-s">Manual Installation</h3>
...
add_filter( 'excerpt_length', 'child_theme_excerpt_length', 20 );</pre>
				...
				<h3 id="posts-formats">Setting Up a Post Format <a href="https://www.webmandesign.eu/portfolio/auberge-plus-wordpress-theme/" target="_blank" class="badge badge-plus">PLUS</a></h3>
		...
		<h2 id="food-menu">Food Menus</h2>
			<div class="section indented">
				...
				<div class="alert alert-info">
					You can disable this theme functionality in <strong><em>Appearance &raquo; Customize &raquo; Theme Options &raquo; Food Menu</em></strong> and use this theme as a business one or blog recipes one.
				</div>
		...
		-->
		<h2 id="recipes">Recipes <a href="https://www.webmandesign.eu/portfolio/auberge-plus-wordpress-theme/" target="_blank" class="badge badge-plus">PLUS</a></h2>
			<div class="section indented">
			...
			<div class="section indented">
				...
				<div class="row">
					...
					<div class="col-sm-12 col-md-6">
						...
						<h4 class="mt"><strong>Custom slider</strong> <a href="https://www.webmandesign.eu/portfolio/auberge-plus-wordpress-theme/" target="_blank" class="badge badge-plus">PLUS</a></h4>
...
.site-banner-media:before { display: none; }</pre>
			...
			<div class="section indented">
				...
				<h3>Widget Areas Contained in the Theme</h3>
					...
					<dl>
						...
						<dt><strong>Custom Banner</strong> <a href="https://www.webmandesign.eu/portfolio/auberge-plus-wordpress-theme/" target="_blank" class="badge badge-plus">PLUS</a></dt>
		...
		<h2 id="customizer">Customizer</h2>
			<div class="section indented">
				...
				<h3>What is Customizer and How to Use It</h3>
					...
					<p>All the custom theme options can be found under <strong><em>Appearance &raquo; Customize &raquo; Theme Options</em></strong> section.</p>

					<div class="alert alert-info">
						<a href="https://www.webmandesign.eu/portfolio/auberge-plus-wordpress-theme/" target="_blank" class="badge badge-plus">PLUS</a> With <a href="https://www.webmandesign.eu/portfolio/auberge-plus-wordpress-theme/" target="_blank">premium version of the theme</a> you get more options to control the theme's appearance and functionality.
					</div>
					...
					<div class="alert alert-danger">
						...
						<ul>
							...
							<li>If none of the above helps, please <a href="https://www.webmandesign.eu/reference/#links-support">contact WebMan Design Support Forums</a>.</li>
						</ul>
					</div>
		...
		<h2 id="seo">Search Engine Optimization and Traffic Tracking</h2>
			<div class="section indented row">
				...
				<div class="col-sm-12 col-md-6">
					...
					<div class="alert alert-info">
						<a href="https://www.webmandesign.eu/portfolio/auberge-plus-wordpress-theme/" target="_blank" class="badge badge-plus">PLUS</a> The <a href="https://www.webmandesign.eu/portfolio/auberge-plus-wordpress-theme/" target="_blank">premium version of the theme</a> supports Google Recipe View for the recipes.
					</div>
		...
		<h2 id="localization">Localization</h2>
			<div class="section indented">
				...
				<div class="alert alert-info">
					...
					If you would like to help out translating the theme, please contribute on <a href="https://www.webmandesign.eu/reference/#links-support">WebMan Design Support Forums</a>.
				</div>
		...
		<h2 id="child-theme">Theme Modifications <small>and Child Themes</small> <a href="https://github.com/webmandesign/child-theme" class="btn btn-success alignright">Download the sample child theme</a></h2>
			<div class="section indented">
				...
				<div class="alert alert-danger">
					<strong>Please note that <a href="https://www.webmandesign.eu/reference/#links-support" target="_blank">we do not provide support for custom theme modifications</a>, though.</strong> You are responsible for all the changes you apply to the theme on your website. If you are not comfortable coding, please, consider hiring someone who could help.
				</div>
			...
			<div class="section indented">
					...
					<div class="row">
						...
						<div class="col-sm-12 col-md-6">
							...
							<dl>
								...
								<dt><code>quote_source</code> <a href="https://www.webmandesign.eu/portfolio/auberge-plus-wordpress-theme/" target="_blank" class="badge badge-plus">PLUS</a></dt>
								<dd>
				...
				<h3 id="hooks">
					...
					<div class="alert alert-danger">
						...
						<strong>Please note that <a href="https://www.webmandesign.eu/reference/#links-support" target="_blank">we do not provide support for custom theme modifications</a>, though.</strong>
					</div>
					...
					<p>Please check the theme's source code for which hook to use, or contact <a target="_blank" href="https://www.webmandesign.eu/reference/#links-support">WebMan Design Support Forums</a> for more details and tips.</p>
	...
	<footer class="footer"><div class="container-fluid">
		...
		<p>Once again, thank you for using the Auberge WordPress theme. If you have any questions that are beyond the scope of this user manual, please join <a target="_blank" href="https://www.webmandesign.eu/reference/#links-support">WebMan Design Support Forums</a>. I will do my best to assist you.</p>
		<p>If you like the theme, please rate it on the marketplace where you've purchased the theme from. Thank you!</p>
		<p>&copy; <a href="https://www.webmandesign.eu">WebMan Design</a> | <a href="#">Back to top &uarr;</a></p>
